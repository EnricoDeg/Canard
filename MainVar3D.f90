...
! real(kind=nr),parameter :: alpha10=2/21.0_nr
! real(kind=nr),parameter :: alpha12=9/7.0_nr
! real(kind=nr),parameter :: beta13=5/21.0_nr
! real(kind=nr),parameter :: a10=-13/36.0_nr
! real(kind=nr),parameter :: a12=6/7.0_nr
! real(kind=nr),parameter :: a13=43/63.0_nr
! real(kind=nr),parameter :: a14=1/84.0_nr
!
! real(kind=nr),parameter :: alpha01=104668/13521.0_nr
! real(kind=nr),parameter :: beta02=25292/4507.0_nr
! real(kind=nr),parameter :: a01=-251170/40563.0_nr
! real(kind=nr),parameter :: a02=38813/4507.0_nr
! real(kind=nr),parameter :: a03=5426/4507.0_nr
! real(kind=nr),parameter :: a04=-11771/162252.0_nr
